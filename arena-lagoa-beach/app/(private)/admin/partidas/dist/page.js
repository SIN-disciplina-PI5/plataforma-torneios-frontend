...
function DetalhesPartida(_a) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement("div", { className: "flex items-center justify-center" },
            React.createElement("button", { type: "button", onClick: onFinalizar, disabled: finalizando || partidaFinalizada, className: "mt-5 h-10 w-50  rounded-lg bg-red-600 text-sm font-bold text-white transition hover:bg-red-700 disabled:cursor-not-allowed disabled:opacity-60" }, finalizando ? "Finalizando..." : "Finalizar partida"))));
}
